package com.example.ha.ToeicReading.question;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.example.ha.ToeicReading/databases/";
...
// Hủy (drop) bảng cũ nếu nó đã tồn tại.
        db.execSQL("DROP TABLE IF EXISTS toeicwword");
